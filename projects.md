...
## 2. WorkoutApp
PWA orientada a la gestion visual de entrenamientos con persistencia offline. Implementa Service Workers para garantizar operatividad sin conexion y temporizadores dinamicos para control de intervalos en tiempo real.
